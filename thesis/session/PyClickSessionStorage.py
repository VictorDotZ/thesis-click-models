...
from pyclick.utils.VKViewSessionParser import VKViewSessionParser
from pyclick.utils.Utils import Utils
from pyclick.search_session.SearchResult import SearchResult
from pyclick.search_session.SearchSession import SearchSession


class PyClickSessionStorage:
    """
    ...
    def __init__(
        self, path: Path, parser=VKViewSessionParser(), ratio: float = 0.75
    ) -> None:
        self.path = path
        self.parser = parser
